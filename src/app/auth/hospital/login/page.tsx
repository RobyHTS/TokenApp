      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 mt-1">Access your hospital management panel</p>
          </div>
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            New hospital?{" "}
            <Link href="/auth/hospital/register" className="text-blue-600 hover:underline font-medium">
              Register here
            </Link>
          </p>
